...
import { filteredTodoListState, todoListState } from "../TodoList/atom";
import { todoStatistcsState, todoStatisticsModalOpenState } from "./atom";
...
const TodoStatisticsModal: React.FC = () => {
  ...
  const statistics = useRecoilValue(todoStatistcsState(selectedDate));
